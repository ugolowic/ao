        ...
        if a.elem_dtype == torch.float8_e4m3fn:
            ...
            if torch_version_at_least("2.10.0") and not isinstance(a.qdata, DTensor):
                res = F.scaled_mm(
                    ...
                    swizzle_a=SwizzleType.SWIZZLE_32_4_4 if data_is_cuda else SwizzleType.NO_SWIZZLE,
                    swizzle_b=SwizzleType.SWIZZLE_32_4_4 if data_is_cuda else SwizzleType.NO_SWIZZLE,
                    bias=bias,
